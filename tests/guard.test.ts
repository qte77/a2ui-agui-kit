...
import { detectInjection } from "../src/guard.js";

// Ported from ldnmxx-hack's worker/test/guard.test.ts.

describe("detectInjection", () => {
  it("passes an ordinary benign sentence (no false positive)", () => {
  ...
  it("passes empty-string input", () => {
    expect(detectInjection("").flagged).toBe(false);
  });

  it("flags a known instruction-override injection string", () => {
